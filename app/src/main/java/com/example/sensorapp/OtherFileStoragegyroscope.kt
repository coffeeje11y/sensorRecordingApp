...
class OtherFileStoragegyroscope(context: Context, workerParams: WorkerParameters) :
    Worker(context, workerParams) {

    private val fileAppend = true
    private var fileName: String = "SensorLog_gyroscope_${inputData.getString("userName")}"
